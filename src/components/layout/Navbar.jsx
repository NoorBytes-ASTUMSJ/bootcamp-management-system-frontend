export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-theme-surface/90 backdrop-blur-md border-b border-theme-border transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {/* Center Nav Links */}
        <nav className="hidden md:flex items-center gap-6 text-xs font-medium text-theme-muted">
          <button
            type="button"
            onClick={() => onNavigatePage && onNavigatePage("home")}
            className={`cursor-pointer transition-colors focus:outline-none ${
              currentView === "home"
                ...
                : "hover:text-theme-text pb-0.5 border-b-2 border-transparent"
            }`}
          >
            Home
          </button>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="text-xs font-semibold text-theme-text hover:text-[#B93325] px-3 py-1.5 transition-colors cursor-pointer focus:outline-none"
          >
            Log in
          </button>
          <button
