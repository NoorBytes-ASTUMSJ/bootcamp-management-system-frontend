...
const StatusBadge = ({ status }) => {
  let styles = "text-[#171717] font-medium";
  if (status === "Present")
    styles =
      "bg-green-100 text-green-700 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wide uppercase";
  if (status === "Late")
    styles =
      "bg-orange-100 text-orange-700 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wide uppercase";
    ...
    >
      ...
      <defs>
        <linearGradient id="redGradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#B93325" stopOpacity="0.15" />
          <stop offset="100%" stopColor="#B93325" stopOpacity="0" />
        </linearGradient>
      </defs>
      <polygon
  ...
  return (
    <div className="mx-auto max-w-[1100px] p-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="text-[28px] font-bold text-[#171717] tracking-tight">
            Attendance Overview
          </h1>
        ...
        <button className="inline-flex items-center gap-2 rounded-md border border-[#E5E5E5] bg-white px-4 py-2 text-sm font-medium text-[#171717] hover:bg-[#F8F8F6] transition-colors shadow-sm">
          <FiCalendar className="h-4 w-4 text-[#777777]" />
          This Month
          <FiChevronDown className="h-4 w-4 text-[#777777] ml-1" />
        </button>
      </div>

      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
        <div className="flex items-center justify-between rounded-xl border border-[#E5E5E5] bg-white p-5">
          <div>
            ...
            <h4 className="text-[28px] font-bold text-[#B93325] leading-none mb-1">
              {overview.percentage}%
            </h4>
        ...
        <div className="flex items-center justify-between rounded-xl border border-[#E5E5E5] bg-white p-5">
          <div>
            <p className="text-xs font-bold text-[#171717] mb-1">Present</p>
            <h4 className="text-[28px] font-bold text-green-600 leading-none mb-1">
        ...
        <div className="flex items-center justify-between rounded-xl border border-[#E5E5E5] bg-white p-5">
          <div>
            <p className="text-xs font-bold text-[#171717] mb-1">Absent</p>
            <h4 className="text-[28px] font-bold text-[#B93325] leading-none mb-1">
          ...
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#B93325]/10 text-[#B93325]">
        ...
        <div className="flex items-center justify-between rounded-xl border border-[#E5E5E5] bg-white p-5">
          <div>
            <p className="text-xs font-bold text-[#171717] mb-1">Late</p>
            <h4 className="text-[28px] font-bold text-orange-500 leading-none mb-1">
              {overview.late.count}
            </h4>
            <p className="text-[11px] font-medium text-[#777777]">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6">
        <div className="rounded-xl border border-[#E5E5E5] bg-white p-6 lg:col-span-2">
        ...
        <div className="rounded-xl border border-[#E5E5E5] bg-white p-6 flex flex-col">
          <h3 className="text-base font-bold text-[#171717] mb-6">
            Attendance Summary
          </h3>
          <div className="flex-1 space-y-5">
            <div className="flex justify-between items-center text-sm">
              <span className="text-[#777777]">Total Sessions</span>
              <span className="font-bold text-[#171717]">
                {overview.totalSessions}
              </span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-[#777777]">Attended</span>
              <span className="font-bold text-[#171717]">
                {overview.attendedSessions}
              </span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-[#777777]">Absent</span>
              <span className="font-bold text-[#171717]">
                {overview.absent.count}
              </span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-[#777777]">Late</span>
              <span className="font-bold text-[#171717]">
                {overview.late.count}
              </span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-[#777777]">Excused</span>
              <span className="font-bold text-[#171717]">
                {overview.excused.count}
              </span>
            </div>
          </div>
          <p className="text-[11px] text-[#9CA3AF] mt-8 pt-4 border-t border-[#F8F8F6] leading-relaxed">
            Percentage is calculated based on applicable sessions.
          </p>
        </div>
      </div>

      <div className="rounded-xl border border-[#E5E5E5] bg-white overflow-hidden flex flex-col mb-10">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-y border-[#E5E5E5] text-[11px] uppercase tracking-wider text-[#777777] font-bold">
            ...
            <tbody className="divide-y divide-[#F8F8F6]">
              {recentSessions.map((session) => (
                <tr
                  key={session.id}
                  className="hover:bg-[#F8F8F6]/50 transition-colors"
                >
        ...
        <div className="border-t border-[#E5E5E5] px-6 py-4 flex items-center justify-center">
