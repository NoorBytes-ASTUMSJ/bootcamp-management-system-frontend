...
import mentorsGroupImg from "../assets/mentors-group.png";
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary transition-colors selection:bg-primary/20 selection:text-primary">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-32 max-w-5xl mx-auto">
        <div className="group p-8 sm:p-10 rounded-3xl bg-surface border border-border hover:border-primary/50 shadow-md hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1.5 transition-all duration-300 grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Left Column: Text */}
          <div className="md:col-span-6 space-y-4">
            <span className="inline-block px-3 py-1 rounded-md bg-secondary text-primary text-[10px] font-mono tracking-wider font-semibold uppercase shadow-2xs">
              Our Philosophy
            </span>
          ...
          <div className="md:col-span-6">
            <div className="overflow-hidden rounded-2xl border border-border group-hover:border-primary/30 shadow-sm transition-colors duration-300">
              <img
                src={mentorsGroupImg}
                alt="ASTU MSJ Mentorship Group"
                className="w-full h-64 sm:h-72 object-cover object-center group-hover:scale-105 transition-transform duration-500 ease-out"
              />
            </div>
          </div>
        </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-28 text-center max-w-3xl mx-auto">
        <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-secondary text-primary mb-4 shadow-2xs hover:scale-110 transition-transform duration-200">
          <MdHandshake className="w-8 h-8" />
        </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-28 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group p-7 sm:p-8 rounded-2xl bg-surface border border-border hover:border-primary/50 shadow-sm hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1.5 transition-all duration-300 flex flex-col">
            <div className="flex items-center gap-3 pb-5 border-b border-border group-hover:border-primary/20 mb-5 transition-colors duration-300">
              <div className="w-10 h-10 rounded-xl bg-secondary border border-border-subtle group-hover:border-primary/40 flex items-center justify-center text-primary transition-colors duration-300 shadow-2xs">
                <svg
              ...
              <h3 className="font-bold text-base sm:text-lg text-text-primary group-hover:text-primary transition-colors duration-200">
                Academic Support
              </h3>
            </div>
            <div className="space-y-3.5 flex-1">
              <div className="flex items-start gap-2.5 text-xs sm:text-sm text-text-muted leading-relaxed">
                <svg
          ...
          <div className="group p-7 sm:p-8 rounded-2xl bg-surface border border-border hover:border-primary/50 shadow-sm hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1.5 transition-all duration-300 flex flex-col">
            ...
            <div className="space-y-3.5 flex-1">
              ...
              <div className="flex items-start gap-2.5 text-xs sm:text-sm text-text-muted leading-relaxed">
                ...
                <span>
                  Support students emotionally and technically throughout the
                  bootcamp.
                </span>
              </div>
            </div>
      ...
      {/* ================= 5. ALUMNI INSIGHTS ================= */}
      <section className="bg-[#0d0e0f] border-t border-b border-[#2d3033] py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="md:col-span-7 space-y-5">
            ...
            <div className="space-y-4 pt-4">
              <div className="group/item flex items-center gap-3 text-xs sm:text-sm text-[#d4d4d4] hover:text-white transition-colors duration-200">
                <div className="w-7 h-7 rounded-lg bg-[#1a1c1e] border border-[#2d3033] group-hover/item:border-primary/40 flex items-center justify-center shrink-0 transition-colors duration-200">
                  <svg
                    className="w-3.5 h-3.5 text-[#a3a3a3] group-hover/item:text-primary transition-colors duration-200"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          {/* Right Column: Quote Card with Hover Glow */}
          <div className="md:col-span-5">
            <div className="p-7 sm:p-8 rounded-2xl bg-[#151718] border border-[#2d3033] hover:border-primary/50 shadow-xl hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-1.5 transition-all duration-300">
